...
export const config = {
  button: {
    ...
    faq: {
      label: 'FAQ',
      url: 'https://hetkin.nl/en/faq-en/',
      target: '_blank'
    },
    team: {
      label: 'Our story',
      url: 'https://hetkin.nl/en/about-us/',
      target: '_blank'
    },
    github: {
      label: 'Join us on GitHub',
      url: 'https://github.com/research-software-directory/KIN-RPD',
      target: '_blank'
    },
    contact: {
      label: 'Contact us',
      url: 'https://hetkin.nl/en/contact-page/',
      target: '_blank'
    },
    news:{
      label: 'More news',
